...
<head>
    ...
    <title> @yield('title') - Al-Asy'ariyyah 9</title>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="{{$url=='categories'?'active':''}}">
                        <a href="{{url('admin/categories')}}"><i class="menu-icon fa fa-list-ul"></i>Data Kepengurusan </a>
                    </li>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <footer class="site-footer">
            <div class="footer-inner bg-white">
                <div class="row">
                    <div class="col-sm-6">
                        Copyright &copy; 2024 Roy Aditya
                    </div>
                    <div class="col-sm-6 text-right">
                        Designed by <a href="https://colorlib.com">Roy</a>
                    </div>
                </div>
            </div>
        </footer>
