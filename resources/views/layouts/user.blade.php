...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="#hero">
          <img src="{{asset('user/images/icon.png')}}" width="56px" height="56px" style="margin-right:5px"/></img>
          <h2 class="d-inline text-light">Al-Asy'ariyyah 9</h2>
        </a>
      </div>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>Roy Aditya</strong>. All Rights Reserved
      </div>
      <div class="credits">
        Designed by <a href="https://bootstrapmade.com/">Roy</a>
      </div>
    </div>
  </footer><!-- #footer -->
